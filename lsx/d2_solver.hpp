...
namespace d2::lsx
{
    ...
    template<typename Value> using hash_set = absl::flat_hash_set<Value>;
    ...
    namespace impl
    {
        ...
        public:
            ...
            template<typename... Argv> void insert(Argv&&... args)
            {
        ...
        public:
            ...
            ConstraintHandle(
                VariableIndex low, VariableIndex high = VariableIndex::Type::Constant
            ) : _low(low), _high(high)
            {
            }
