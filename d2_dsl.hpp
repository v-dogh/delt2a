...
#define D2_NVAR_STR(_type_, _name_, _var_) _D2_IMPL_NVAR_STR(_type_, _name_, _var_)
#define D2_NDYNAVAR_STR(_type_, _name_, _var_, ...) _D2_IMPL_NDYNAVAR_STR(_type_, _name_, _var_, __VA_ARGS__)
#define D2_NVAR(_type_, _name_, _var_) _D2_IMPL_NVAR(_type_, _name_, _var_)
#define D2_NDYNAVAR(_type_, _name_, _var_, ...) _D2_IMPL_NDYNAVAR(_type_, _name_, _var_, __VA_ARGS__)
...
#define D2_SYNC_ASYNC_BLOCK(...) _D2_IMPL_SYNC_ASYNC_BLOCK(__VA_ARGS__)
