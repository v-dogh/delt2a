...
namespace d2::dx
{
    d2::Element::ptr EntrySeed::_get() const noexcept
    {
        return _element;
    }
    void EntrySeed::_insert(d2::Element::ptr ptr)
    {
        _ptr.as<DemandScrollBox>()->_insert_setstate(ptr);
    }
    std::size_t EntrySeed::index() const noexcept
    {
        return _idx;
    }
    d2::TreeIter<DemandScrollBox> EntrySeed::parent() const noexcept
    {
        return _ptr;
    }
    ...
    void DemandScrollBox::_event_impl(in::InputFrame& frame)
    {
        ...
        else if (frame.had_event(in::Event::KeyInput))
        {
    ...
    void DemandScrollBox::_update_view()
    {
        ...
        auto old_at = [&](int i) -> d2::Element::ptr
        {
        ...
        std::vector<d2::Element::ptr> new_view;
