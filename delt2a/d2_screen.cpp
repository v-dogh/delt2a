...
namespace d2
{
	void Screen::_keynav_cycle_up(Element::TraversalWrapper ptr)
	{
	...
	Element::TraversalWrapper Screen::traverse()
	{
		return root();
	}
	Element::TraversalWrapper Screen::operator/(const std::string& path)
	{
