...
#		define D2_UAI_VAR_END else static_assert(false, "Invalid Property");
    ...
    protected:
        ...
        virtual char _index_impl() const noexcept override final
        {
            return this->zindex;
        }
        virtual Element::unit_meta_flag _unit_report_impl() const noexcept override final
        {
            return
    ...
    struct Layout
    {
        ...
        {
            D2_UAI_VAR_START
            D2_UAI_GET_VAR(0, x, LayoutXPos)
            D2_UAI_GET_VAR(1, y, LayoutYPos)
            D2_UAI_GET_VAR_MUL(2, width, Element::WriteType::Style | Element::WriteType::LayoutWidth)
            D2_UAI_GET_VAR_MUL(3, height, Element::WriteType::Style | Element::WriteType::LayoutHeight)
            D2_UAI_GET_VAR(4, zindex, None)
            D2_UAI_VAR_END;
        }
    };
    ...
    struct Container
    {
        ...
        auto at_style()
        {
            ...
            D2_UAI_GET_VAR_COMPUTED(13, Style, impl::uchar_bit_ptr(&container_options, TopFix))
            D2_UAI_GET_VAR_COMPUTED(14, Style, impl::uchar_bit_ptr(&container_options, OverrideCorners))
            D2_UAI_VAR_END;
        }
    };

    template<std::size_t PropBase>
    struct IContainer : Container, InterfaceHelper<IContainer, PropBase, 15>
    {
    ...
    struct Text
    {
        ...
        auto at_style()
        {
            D2_UAI_SETUP_MUL(Element::WriteType::Style)
            D2_UAI_VAR_START
    ...
    struct Responsive
    {
        std::function<void(TreeIter)> on_submit{};
