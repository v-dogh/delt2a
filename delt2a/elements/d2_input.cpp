...
namespace d2::dx
{
	...
	char Input::_index_impl() const noexcept
	{
		return data::zindex;
	}
	Input::unit_meta_flag Input::_unit_report_impl() const noexcept
	{
	...
	Input::BoundingBox Input::_dimensions_impl() const noexcept
	{
		BoundingBox bbox{};
	...
	Input::Position Input::_position_impl() const noexcept
	{
		return {
