...
namespace d2::lsx
{
    ...
    constexpr Variable operator*(Variable var, result_type cf) noexcept
    {
    ...
    constexpr Variable operator*(result_type cf, Variable var) noexcept
    {
        return Variable(var, var.coefficient() * cf);
    }
    constexpr Variable operator/(result_type cf, Variable var) noexcept
    ...
    constexpr Expression operator+(Variable var, result_type cf) noexcept
    {
    ...
    constexpr Expression operator+(result_type cf, Variable var) noexcept
    {
    ...
    constexpr Expression operator+(Variable lhs, Variable rhs) noexcept
    {
...
// Expression (arithmetic)
    ...
    constexpr Expression operator*(const Expression& expr, result_type cf) noexcept
    {
    ...
    constexpr Expression operator*(result_type cf, const Expression& expr) noexcept
    {
        return Expression::from(expr, cf);
    }
    constexpr Expression operator/(result_type cf, const Expression& expr) noexcept
    ...
    constexpr Expression operator+(const Expression& expr, Variable var) noexcept
    {
    ...
    constexpr Expression operator+(Variable var, const Expression& expr) noexcept
    {
        return Expression::from(expr, var, 1);
    }
    constexpr Expression operator-(Variable var, const Expression& expr) noexcept
...
// Expression (constraints)
    ...
    constexpr Expression operator==(const Expression& lhs, const Expression& rhs) noexcept
    {
