...
namespace d2::ctm
{
    ...
    namespace impl
    {
        style::IZThemeSelector::theme_list default_themes()
        {
            return {
                ...
                { {"Nordish Blue",    "Cool" },       { d2::px::background{ 120, 140, 170, 255 }, d2::colors::b::steel_blue } },
                { {"Blueprint",       "Cool" },       { d2::colors::b::dark_slate_blue, d2::colors::b::royal_blue, d2::colors::b::cyan } },
                { {"Graphite/Ice",    "Cool" },       { d2::colors::w::dark_gray, d2::colors::b::steel_blue, d2::colors::b::cyan } },
                // Warm
                ...
                { {"Sunset Coral",    "Warm" },       { d2::px::background{ 120, 90, 110, 255}, d2::colors::r::coral } },
                { {"Coffee",          "Warm" },       { d2::px::background{ 170, 140, 110, 255}, d2::colors::r::chrome_yellow } },
                { {"Autumn",          "Warm" },       { d2::px::background{ 150, 120, 80, 255}, d2::colors::r::firebrick, d2::colors::r::chrome_yellow } },
                // Natural
                ...
                { {"Evergreen",       "Nature" },     { d2::colors::w::gray, d2::colors::g::forest_green, d2::colors::g::aquamarine } },
                { {"Moss/Clay",       "Nature" },     { d2::px::background{ 140, 130, 100, 255}, d2::colors::g::olive, d2::colors::r::coral } },
                // Retro
                { {"Paper/Ink",       "Terminal" },   { d2::colors::w::light_gray, d2::colors::b::indigo } },
                { {"Old CRT",         "Terminal" },   { d2::px::background{ 180, 220, 180, 255}, d2::colors::g::chartreuse } },
                ...
                // Neon
                { {"Cyberpunk",       "Neon" },       { d2::px::background{ 90, 70, 120, 255}, d2::colors::r::magenta, d2::colors::b::cyan } },
                { {"Vaporwave",       "Neon" },       { d2::px::background{ 120, 80, 160, 255}, d2::colors::r::salmon, d2::colors::b::turquoise } },
                { {"Neon Arcade",     "Neon" },       { d2::px::background{ 80, 80, 100, 255}, d2::colors::g::chartreuse, d2::colors::r::magenta } },
                // Minimal
                { {"Steel/Ember",     "Minimal" },    { d2::colors::b::steel_blue, d2::colors::r::coral, d2::colors::r::chrome_yellow } },
                { {"Monochrome",      "Minimal" },    { d2::colors::w::dark_gray, d2::colors::w::silver, d2::colors::b::slate_blue } }
            };
        }
        ...
        D2_STYLESHEET_BEGIN(button_react)
            ...
            D2_INTERP_TWOWAY_AUTO(Hovered, 500, Linear, BackgroundColor, D2_NVAR(WidgetTheme, __Preview__, wg_hbg_button()));
            D2_INTERP_TWOWAY_AUTO(Clicked, 100, Linear, BackgroundColor, D2_NVAR(WidgetTheme, __Preview__, wg_pbg_button()));
            D2_INTERP_TWOWAY_AUTO(Clicked, 100, Linear, ForegroundColor, D2_NVAR(WidgetTheme, __Preview__, wg_pfg_button()));
            D2_STYLE(FocusedColor, D2_NVAR(WidgetTheme, __Preview__, wg_hbg_button()))
        D2_STYLESHEET_END
        D2_STYLESHEET_BEGIN(icon_react)
            D2_STYLE(ForegroundColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_fg_button(), value.stylize(d2::px::foreground::Bold)))
            auto dvar1 = D2_NDYNAVAR(WidgetTheme, __Preview__, wg_hbg_button(), value.stylize(d2::px::foreground::Bold));
            auto dvar2 = D2_NDYNAVAR(WidgetTheme, __Preview__, wg_pbg_button(), value.stylize(d2::px::foreground::Bold));
        ...
        D2_STYLESHEET_BEGIN(switch_color)
            ...
            D2_STYLE(FocusedColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_hbg_button(), value.alpha(0.7f)))
        D2_STYLESHEET_END
        ...
        D2_STYLESHEET_BEGIN(selector_color)
            ...
            D2_STYLE(EnabledBackgroundColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_border_horizontal(),
                px::background{ value.rf, value.gf, value.bf, value.af }))
            D2_STYLE(DisabledForegroundColor, D2_NVAR(WidgetTheme, __Preview__, wg_text()))
            D2_STYLE(DisabledBackgroundColor, colors::w::transparent)
            D2_STYLE(SliderBackgroundColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_hbg_button(), value.extend(charset::slider_vertical)))
            D2_STYLE(SliderColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_hbg_button(), value.extend(charset::slider_thumb_vertical)))
            D2_STYLE(FocusedColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_hbg_button(), value.alpha(0.7f)))
        D2_STYLESHEET_END
        ...
        D2_STYLESHEET_BEGIN(bold_text_color)
            D2_STYLE(ForegroundColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_text(), value.stylize(d2::px::foreground::Bold)))
        D2_STYLESHEET_END
        D2_STYLESHEET_BEGIN(slider_color)
            D2_STYLE(SliderColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_fg_button(),
                value.extend(d2::charset::slider_thumb_horizontal)
            ))
            D2_STYLE(ForegroundColor, D2_NDYNAVAR(WidgetTheme, __Preview__, wg_fg_button(),
    ...
    D2_STATELESS_TREE(theme_picker, bool window)
        ...
        auto apply_accents = [=](StandardTheme* ptr, const style::IZThemeSelector::accent_vec& accents) {
            if (!accents.empty())
            {
                ...
                {
                    StandardTheme::accent_dynamic_duotone(
                        ptr,
                        accents[0],
                        accents[1]
                    );
                ...
                {
                    StandardTheme::accent_dynamic_tritone(
                        ptr,
                        accents[0],
                        accents[1],
                        accents[2]
        ...
        D2_ELEM(FlowBox, logic)
                            ...
                            D2_ELEM(FlowBox)
                                ...
                                D2_ELEM_ANCHOR(controls)
                                    ...
                                    D2_ELEM(Button, up)
                                        ...
                                        D2_STYLE(X, 0.0_relative)
                                        D2_STYLE(OnSubmit, [=](d2::TreeIter<Button>) {
                        ...
                        D2_ELEM(FlowBox)
                            ...
                            D2_ELEM(Button)
                                ...
                                D2_STYLE(OnSubmit, [=](d2::TreeIter<Button>) {
                                    ...
                                    apply_accents(&state->screen()->theme<StandardTheme>("__Preview__"), _bcore(state)->accents());
                                })
                                D2_STYLES_APPLY(button_react)
                            D2_ELEM_END
                        D2_ELEM_END
            ...
            D2_ELEM(FlowBox)
                ...
                D2_ELEM_ANCHOR(immediate_toggle)
                    D2_STYLE(X, 1.0_relative)
                    D2_STYLE(OnSubmit, [=](d2::TreeIter<Checkbox>, bool) {
                        update_accents(_bcore(state)->accents());
                    })
                ...
                D2_ELEM(ScrollFlowBox, preview)
                    ...
                    D2_ELEM(FlowBox)
                        ...
                        D2_ELEM(Text)
                            D2_STYLE(Value, "Lorem Ipsum Dolor, <something something>\nBlah Blah Blah, some sample words\nlol")
    ...
    ThemeSelectorWindow::ThemeSelectorWindow(const std::string& name, TreeState::ptr state) : data(name, state)
    {
        data::themes = impl::default_themes();
    }
